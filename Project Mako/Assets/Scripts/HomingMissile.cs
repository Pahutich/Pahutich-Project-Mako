...
public class HomingMissile : Projectile
{
    ...
    {
        var potentialTargets = GameObject.FindObjectsOfType<Health>().ToList().Where(h => h != GameObject.FindGameObjectWithTag("Player").GetComponent<Health>());
        float minDist = Mathf.Infinity;
        Health candidateTarget = null;
